                            ...
                            .addOnCompleteListener(task -> {
                                if (task.isSuccessful()) {
                                    ...
                                    if (usernameExists) {
                                        ...
                                        Toast.makeText(SignUpActivity.this, "Tên người dùng đã tồn tại. Vui lòng chọn một cái khác.", Toast.LENGTH_LONG).show();
                                    } else {
                                                    ...
                                                    if (idTask.isSuccessful() && !idTask.getResult().isEmpty()) {
                                                        ...
                                                        table_user.add(userData)
                                                                .addOnSuccessListener(documentReference -> {
                                                                    mDialog.dismiss();
                                                                    Toast.makeText(SignUpActivity.this, "Người dùng đã đăng ký thành công!", Toast.LENGTH_SHORT).show();
                                                                ...
                                                                .addOnFailureListener(e ->
                                                                        Toast.makeText(SignUpActivity.this, "Không thể lưu người dùng: " + e.getMessage(), Toast.LENGTH_LONG).show());
                                                    } else {
                                    ...
                                    Toast.makeText(SignUpActivity.this, "Không thể lưu người dùng: " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                }
                            });
                }
            }
